...
@Slf4j
@Aspect
@RestControllerAdvice(basePackages = {"org.asst.controller"})
public class GlobalHandler {

    /**
     * 'controller..' 表示controller包及其子包
     */
    @Pointcut("execution(public * org.asst.controller..*.*(..)) && (@annotation(org.springframework.web.bind.annotation.GetMapping) || @annotation(org.springframework.web.bind.annotation.PostMapping) || @annotation(org.springframework.web.bind.annotation.PutMapping) || @annotation(org.springframework.web.bind.annotation.DeleteMapping))")
