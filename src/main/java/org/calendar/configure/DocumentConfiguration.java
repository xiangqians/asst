package org.calendar.configure;
...
public class DocumentConfiguration {
    ...
    // 文档标题
    private static final String TITLE = "Calendar API";
    // 文档描述
    private static final String DESCRIPTION = "calendar";

    // 组名称
    private static final String DEFAULT_GROUP_NAME = "default";
    // 基础包
    public static final String[] BASE_PACKAGES = {"org.calendar.controller"};
    ...
    public static abstract class AbstractDocket extends Docket {
        ...
        public void init() {
            ...
            ApiInfo apiInfo = new ApiInfoBuilder()
                    ...
                    // 联系
                    .contact(new Contact("xiangqian", "https://github.com/xiangqians/calendar", "xiangqian@xiangqians.com"))
                    .build();
            apiInfo(apiInfo);
