package org.calendar.pagination;
...
public class PageRequest implements VoParam {
    ...
    @Max(value = 10000, message = "当前页不能大于10000")
    @NotNull(message = "当前页不能为空")
    @ApiModelProperty(value = "当前页", example = "1", required = true)
    private Long current;

    @Min(value = 1, message = "页数量必须大于0")
    @Max(value = 100, message = "页数量不能大于100")
    ...
    @ApiModelProperty(value = "排序命令，1-升序，2-降序", allowableValues = "1,2")
